...
{{--                                    {!! Form::label('counter', 'Counter:') !!}--}}
                                ...
                                {!! Form::text('id', 'New Vendor ID will be Generated Automatically', ['class' => 'form-control','aria-describedby'=>"basiaddon1","disabled"=>"true"]) !!}
                                {!! Form::hidden('counter', 1, ['class' => 'form-control','aria-describedby'=>"basiaddon1"]) !!}
                            </div>
                        </div>
...
{{--                            {!! Form::number('category', null, ['class' => 'form-control']) !!}--}}
                                {!! Form::select('category', $categories_array, old('category',null), ['class' => 'form-control','placeholder' => 'Select Category...'])!!}
...
{{--                            {!! Form::text('contact_name', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                            {!! Form::label('keywords', 'Keywords:') !!}--}}
                            {!! Form::text('keywords', null, ['class' => 'form-control','maxlength' => 255]) !!}
                            </div>
                        </div>
                        <!-- Keywords Field -->
                        <div class="form-group col-sm-4">
...
{{--                            {!! Form::label('keywords', 'Keywords:') !!}--}}
                            {!! Form::text('brands', null, ['class' => 'form-control','maxlength' => 255]) !!}
                            </div>
                        </div>
...
{{--                            {!! Form::label('job_title', 'Job Title:') !!}--}}
                            {!! Form::text('job_title', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}
                            </div>
                        </div>
...
{{--                            {!! Form::label('mobile_phone_1', 'Mobile Phone 1:') !!}--}}
                            {!! Form::text('mobile_phone_1', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}
                            </div>
                        </div>
...
{{--                            {!! Form::label('mobile_phone_2', 'Mobile Phone 2:') !!}--}}
                            {!! Form::text('mobile_phone_2', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
{{--                            {!! Form::label('address', 'Address:') !!}--}}
                            {!! Form::textarea('address', null, ['class' => 'form-control','rows'=>8]) !!}
                            </div>
                        </div>
<div class="col-sm-6">
    <div class="row">
...
{{--                {!! Form::text('country', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}--}}
                {!! Form::select('country', $countries, old('country',null), ['class' => 'form-control','placeholder' => 'Select Country...'])!!}
            </div>
        </div>
    </div>
</div>
